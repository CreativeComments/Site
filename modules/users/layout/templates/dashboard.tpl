                ...
                <div class="row-fluid">
                    ...
                    <div class="span7 download">
                        <header>
                            ...
                            <ol>
                                <li>
                                    We support the Google Chrome browser. Please
                                    <a href="https://www.google.com/chrome">download and install</a> the browser first - it's free!
                                </li>
                                <li>
                                    Install the
                                    <a href="https://chrome.google.com/webstore/detail/creative-comments/helhdkbppnbmifdjhhiecciflfneoedj?hl=en">Google Chrome plug-in</a> to start creating your Creative Comments - easy enough!
                                </li>
                            </ol>
                        </header>
                    </div>
