<!doctype html>
<!--[if lte IE 8 ]> <html style="height: 100%" lang="{$LANGUAGE}" class="ie8 ie"> <![endif]-->
<!--[if IE 9 ]> <html style="height: 100%" lang="{$LANGUAGE}" class="ie9 ie"> <![endif]-->
<!--[if (gt IE 9)|!(IE)]><!--> <html style="height: 100%" lang="{$LANGUAGE}"> <!--<![endif]-->
<head>
	<meta charset="utf-8">
	...
	<link rel="stylesheet" href="/core/flowplayer/skin/minimalist.css?m={$LAST_MODIFIED}">
	{option:css}
		{iteration:css}
	...
	<script src="/core/flowplayer/flowplayer.js?m={$LAST_MODIFIED}"></script>
...
<body class="videoPlayer">
	<div id="flowplayer" style="width: 100%; height: 100%;">
	</div>
</body>
</html>